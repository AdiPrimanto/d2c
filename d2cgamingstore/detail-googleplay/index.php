...
<body class="bg-variant-1">
                        ...
                        <div class="card">
                            <div class="card-body" id="idUser">
                                <div class="d-flex gap-3 align-items-baseline">
                                    ...
                                    <h5 class="card-title fz-16">Masukkan Email</h5>
                                </div>
                                <input class="form-control mt-3" type="text" placeholder="Masukkan Username Yostar / FB / Twitter" aria-label="default input example">
    ...
    <script>
        ...
        function usePromo() {
            ...
            var removeSpaces = getPromo.replace(/\s+/g, '');
            $('.code-promo .discount').text(removeSpaces).css('font-weight', 'bold').css('text-transform', 'uppercase');
