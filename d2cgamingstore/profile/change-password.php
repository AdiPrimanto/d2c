            ...
            <div class="row mb-4">
                <div class="col">
                    <div>
                        ...
                        <h3 class="text-white">Ubah Kata Sandi</h3>
                        <p class="text-white">Silahkan masukkan kata sandi baru anda, usahakan untuk berbeda dengan kata sandi lama anda!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <form action="" class="custom-form pb-4">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="autoSizingInputGroup">Konfirmasi Kata Sandi</label>
                            <div class="input-group mb-3">
                                <input class="form-control" type="password" id="repassword" name="repassword" placeholder="Masukkan kata sandi Anda" value="">
                                <span class="input-group-text">
                        ...
                        <div class="form-group">
                            <button class="btn btn-orange w-100" type="submit">Ubah Kata Sandi</button>
                        </div>
                    </form>
                </div>
            </div>
