    ...
    <section>
        <div class="container min-h-100vh bg-variant py-4 pt-0">
            <div class="row text-center position-relative" id="updatesPage">
                <div class="col">
                    <div>
                        ...
                        <h3 class="text-white mt-5">Tentang Kami</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row my-2 text-white">
                <div class="col">
                    <div>
                        <h4 class="mb-3">DITUSI Gaming</h4>
                        <p class="mb-0 text-opacity">
                    ...
                    <table>
                        <tr>
                            <td class="align-baseline pe-2 pb-2">
                                <img src="../../assets/icons/Back.png" alt="">
                            </td>
                            <td class="fz-16 text-white pb-2">
                                <div class="fw-bolder mb-2">Lorem ipsum dolor sit amet</div>
