        ...
        <div class="container min-h-100vh bg-variant py-4 pt-0">
            ...
            <div class="row">
                <div class="col">
                        ...
                        <div class="card-body bg-variant-5">
                            ...
                            <ul id="less-detail" class="list-unstyled line-height-3 text-variant text-white fz-14">
                                ...
                                <li class="d-flex justify-content-between">
                                    ...
                                    <p class="mb-0 fw-500">QRIS (E-Wallet)</p>
                                </li>
                                <li class="d-flex justify-content-between">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="../detail-direct-topup/index.php" class="btn btn-orange-secondary w-100 mt-3" style="background-color: transparent !important;">
            ...
            <div class="row mt-5">
                <div class="col">
                    <div class="card bg-variant-6">
                        <div class="card-body bg-variant-5">
                            <h5 class="card-title mb-2 text-white Inter">Scan QR Code</h5>

                            <div class="text-center my-3">
                                <img src="../../assets/images/img/qr.png" class="img-fluid" alt="">
                            </div>
                            <div class="text-center">
                                <a href="../../assets/images/img/qr.png" class="text-white text-decoration-none mt-3" download>
                                    Unduh QR Code <i class="bi bi-download ml-75"></i>
                                </a>
                            </div>
                        </div>
                    </div>
